...
namespace Domains.Map.Pathfinding
{
    ...
    public interface IHexPathfindingUtility
    {
        ...
        /// </summary>
        /// <param name="hexQuery">Query that provides the current pathfinding domain.</param>
        ...
        bool TryFindPath(ArchetypeQuery hexQuery, HexCoord start, HexCoord end, Allocator allocator, out NativeList<HexCoord> path);
    }
}
