...
{
    /// <summary>
    ///     One-frame event requesting the district-build overlay be opened for the selected hex. Raised via
    ///     <c>EntityStore.CreateEvent</c> by the build slot in <c>HexInfoPanelView</c>; payload-less by design
    ...
    /// </summary>
    public struct DistrictBuildUIRequestedEvent : IComponent
    {
    }
}
