...
{
    /// <summary>
    ///     Runs mountain generation when invoked by <see cref="TerrainGenerationSystem" />.
    ...
    /// </summary>
    [UsedImplicitly]
    internal sealed class MountainGenerationSystem : GenerationSystem
    {
        ...
        public MountainGenerationSystem(World world)
        {
