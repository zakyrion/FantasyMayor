...
{
    /// <summary>
    ///     Runs sea generation when invoked by <see cref="TerrainGenerationSystem" />.
    ...
    /// </summary>
    [UsedImplicitly]
    internal sealed class SeaGenerationSystem : GenerationSystem
    {
        ...
        public SeaGenerationSystem(World world)
        {
