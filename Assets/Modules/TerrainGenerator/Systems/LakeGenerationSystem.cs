...
{
    /// <summary>
    ///     Runs lake generation when invoked by <see cref="TerrainGenerationSystem" />.
    ///     Generates a single connected lake near the map centre with area derived from
    ///     <see cref="LakeConfigComponent.SizeFraction" />.
    /// </summary>
    [UsedImplicitly]
    internal sealed class LakeGenerationSystem : GenerationSystem
    {
