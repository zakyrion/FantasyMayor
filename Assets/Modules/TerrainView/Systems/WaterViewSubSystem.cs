...
{
    /// <summary>
    ///     Generates an animated water surface mesh covering all <see cref="HexWaterTag" /> hexes and
    ...
    internal sealed class WaterViewSubSystem : ViewSubSystem
    {
        ...
        /// <summary>
        ///     Collects all hex entities carrying <see cref="HexWaterTag" /> into a
        ...
        private NativeHashSet<HexCoord> CollectWaterHexCoords()
        {
            ...
            var waterHexes = new NativeHashSet<HexCoord>(
        ...
        /// <summary>
        ///     Collects all hex entities that are adjacent to at least one water hex but do not
        ///     carry <see cref="HexWaterTag" /> themselves (the shoreline ring).
