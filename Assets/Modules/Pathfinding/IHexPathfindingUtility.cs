...
namespace Modules.Pathfinding
{
    ...
    public interface IHexPathfindingUtility
    {
        ...
        /// </summary>
        /// <param name="hexSet">Entity set that provides the current pathfinding domain.</param>
        ...
        bool TryFindPath(EntitySet hexSet, HexCoord start, HexCoord end, Allocator allocator, out NativeList<HexCoord> path);
    }
}
