...
"System Taxonomy"):
- **`HexInfoPanelSpawnSystem`** — Pipeline Stage (800): loads the shared panel instance, owns the
  addressable handle, publishes the view singleton, leaves the panel hidden.
