...
{
    /// <summary>
    ///     Read/write access to the single <c>"world"</c> singleton entity that carries every former
    ///     DefaultEcs world component (see PLAN_FRIFLO_MIGRATION.md → World components spec). The singleton
    ///     is created once in <c>WorldInstaller</c>, before any world-component write.
    /// </summary>
