namespace EcsExtensions
{
    ...
    public static class SystemPriorities
    {
        ...
        public static class RuntimeTick
        {
            ...
            public const int DistrictBuildProgressViewSpawn = 601; // spawns the progress view for the just-created District row
            public const int BuildDistrictActionCancel = 602; // consumes BuildDistrictCancelEvent, disposes both rows, raises DistrictTableChangedEvent{Removed}
            public const int BuildDistrictCompletion = 603; // consumes the completed pulse, flips the District row to Built, raises DistrictTableChangedEvent{Built}
            ...
            public const int DistrictBuildProgressViewDespawn = 604; // removes the progress view once its District row stops being Planned
            public const int DistrictViewSpawn = 605; // spawns the built-district view
            public const int ForestDespawn = 606;
            public const int DistrictOpenConditionEvaluatorTableChanged = 610; // re-gates open conditions off DistrictTableChangedEvent{Planned/Built/Removed} from confirm, cancel, or completion
            public const int HexIconsContainerPosition = 700; // > Camera (0): re-projects after the camera moves this frame
