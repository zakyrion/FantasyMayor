...
namespace Utils
{
    public static class HexesMeshUtil
    {
        ...
        [BurstCompile]
        public static int FirstVertexInWave(int wave)
        {
            return wave switch
            {
                0 => 0,
        ...
        [BurstCompile]
        public static int VerticesCountInHex(int wave)
        {
            return 1 + 3 * wave * wave + 3 * wave;
        }

        [BurstCompile]
        public static int VerticesCountInWave(int wave)
        {
            return wave switch
            {
                0 => 1,
