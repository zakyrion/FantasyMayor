...
| [PLAN_FRIFLO_MIGRATION.md](PLAN_FRIFLO_MIGRATION.md) | when executing the FM-13 DefaultEcs→Friflo migration — the executor's sole entry point; delete this doc when :s8 lands | Closed-spec plan: DefaultEcs 0.17.2 → Friflo.Engine.ECS 3.6.0. Executor = Sonnet 5; one phase per session. |
