...
- [FantasyMayor — Architecture Reference](ARCHITECTURE.md) — Every new feature should still prefer `Assets/Modules/<FeatureName>/` and use this target layout:
...
| [HexCore](Assets/Modules/HexCore/HEX_CORE.md) | A | implemented | Core hex grid data structures and terrain tag components. |
| [HexIcons](Assets/Modules/HexIcons/HEXICONS.md) | A | partial | Manages per-hex UI icon badges using a UI Toolkit Screen-Space overlay. |
...
| [TerrainGenerator](Assets/Modules/TerrainGenerator/TERRAIN_GENERATOR.md) | A | implemented | Procedural terrain generation: hex grid creation, mountains with foothills, and water (river / lake / sea). |
| [TerrainView](Assets/Modules/TerrainView/TERRAIN_VIEW.md) | A | implemented | Renders procedural terrain: subdivided hex mesh, isoline height fields, erosion, procedural |
| [WATER_VIEW_SETUP.md](Assets/Modules/TerrainView/WATER_VIEW_SETUP.md) | A | stub | Замінити на Uber-Stylized-Water. |
